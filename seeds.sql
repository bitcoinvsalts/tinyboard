...
VALUES (1, 'JK', 'blue', 'Does anyone have experience raising young hippos?<br><br>I''m trying to housetrain one I got for my birthday but we''ve had a few, shall we say, "accidents" so far.<br><br>Training Henry has been far harder than any of the dogs I''ve had!'),
       ...
       (2, 'KB', 'purple', '![10/10](https://i.imgur.com/06bFgD2.gif)<br><br>Love it, thx for sharing!'),
       (3, 'DL', 'red', 'Share your best NBA gifs!<br><br>Bring them on!<br><br>![Alt text](https://i.imgur.com/ao5tOjM.gif)'),
       (3, 'MB', 'blue', '![Kobe doesn''t flinch](https://i.imgur.com/uOPgcGJ.gif)'),
       (3, 'JH', 'red', '@MB nice try bro **LOL**<br><br>![James Harden](https://i.imgur.com/X0yWmKZ.gif)'),
       (3, 'KI', 'green', '![Kyrie''s big shot](https://i.imgur.com/IM8y2mL.gif)'),
       (3, 'KB', 'purple', 'tfw someone says hard tacos are best<br><br>![Alt text](https://i.imgur.com/HPnZFlO.gif)');
